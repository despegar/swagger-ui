...
### Install
Use `gulp installM2` to upload a jar with the resources to local Maven repository.
Use `gulp deployM2` to upload a snapshot.
Use `gulp releaseM2` to make a release.
